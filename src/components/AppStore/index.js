...
class AppStore extends Component {
  ...
  changingActiveTabItemId = tabId => {
    this.setState({activeTabId: tabId})
  }

  changeInInputValue = event => {
  ...
  render() {
    ...
    const searchFilter = appsList.filter(eachItem =>
      eachItem.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
    const filteredAppList = searchFilter.filter(
      ...
      <div className="main-container">
        ...
        <div className="search-input">
          <input
            ...
            value={searchInput}
            onChange={this.changeInInputValue}
          />
          <img
          ...
          <ul className="tab-items-container">
            {tabsList.map(eachItem => (
              <TabItem
                tabDetails={eachItem}
                key={eachItem.tabId}
                onClickTabItem={this.changingActiveTabItemId}
